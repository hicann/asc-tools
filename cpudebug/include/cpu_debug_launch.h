...
namespace AscendC {
extern "C" __attribute__((visibility("hidden"))) __attribute__((weak)) uint32_t __asc_LaunchAndProfiling(
    const char* kernelName, uint32_t blockDim, void* stream, void** args, uint32_t size,
    const uint32_t ubufDynamicSize);
