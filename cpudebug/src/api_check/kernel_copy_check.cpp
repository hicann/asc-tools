...
bool TikcppCopyCheck::CheckAllLowLevel(std::vector<uint64_t> maskArray)
{
    ...
    TensorOverflowParams params = {
        param_.dstSize,
        static_cast<uint64_t>(param_.dstDtypeBytes),
        static_cast<uint64_t>(param_.repeatTimes),
        static_cast<uint64_t>(param_.dstStride),
        static_cast<uint64_t>(param_.dstRepeatSize),
        false};
    ASCENDC_CHECK(CheckTensorOverflowLow(maskArray, params, "dstLocal"));
    params = {
        param_.srcSize,
        static_cast<uint64_t>(param_.srcDtypeBytes),
        static_cast<uint64_t>(param_.repeatTimes),
        static_cast<uint64_t>(param_.srcStride),
        static_cast<uint64_t>(param_.srcRepeatSize),
        false};
