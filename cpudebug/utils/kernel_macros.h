...
#endif
#if (                                                                                                       \
    defined(__NPU_ARCH__) && ((__NPU_ARCH__ == 1001) || (__NPU_ARCH__ == 2002) || (__NPU_ARCH__ == 2201) || \
                              (__NPU_ARCH__ == 3002) || (__NPU_ARCH__ == 3510)))
#ifndef ASCENDC_DUMP
...
namespace AscendC {
                              ...
                              (__NPU_ARCH__ == 3102) || (__NPU_ARCH__ == 3510)) // Available for V200 and V210
