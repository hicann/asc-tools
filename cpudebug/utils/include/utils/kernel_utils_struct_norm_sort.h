...
enum class eltwise_op_t { No_Eltwise = 0, Add, Sub, Mul, Max };

enum class ClipReluMode_t { NoClipRelu = 0, ScalarClipRelu };
#endif
...
template <typename T>
__aicore__ inline uint64_t GetScalarBitcodeValue(T scalarValue)
{
    union ScalarBitcode {
...
__aicore__ inline U GetScalarBitcodeValue(T scalarValue)
{
    union ScalarBitcode {
        __aicore__ ScalarBitcode() {}
        T input;
