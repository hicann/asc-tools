...
INSTANTIATE_TEST_CASE_P(
    TEST_BINARY_SCALAR_API_CHECK, TestBinaryScalarpiCheckSuite,
    ::testing::Values(
        TestBinaryScalarApiCheckParams{256, TPosition::VECCALC, 1, 1, 8, 8, 1, 256, true},
...
INSTANTIATE_TEST_CASE_P(
    TEST_BINARY_SCALAR_API_HIGH_CHECK, TestBinaryScalarApiHighCheckSuite,
    ::testing::Values(
        TestBinaryScalarApiCheckParams{512, TPosition::VECCALC, 1, 1, 8, 8, 1, 256, true},
