...
protected:
    void SetUp() { KernelPrintLock::printLock = nullptr; }
...
void* MmapStub1(void* start, size_t length, int prot, int flags, int fd, off_t offset) { return ((void*)-1); }

int MunmapStub1(void* start, size_t length) { return -1; }

int32_t RaiseStub1(int32_t i) { return 0; }
