...
foreach(required IN ITEMS TEST_EXECUTABLE FAKE_TOOL TEST_ROOT RUNTIME_ROOT INJECTION_LIBRARY_DIR)
...
execute_process(
  COMMAND "${CMAKE_COMMAND}" -E env
    ...
    "LD_LIBRARY_PATH=${RUNTIME_ROOT}/x86_64-linux/lib64:${INJECTION_LIBRARY_DIR}"
    "${TEST_EXECUTABLE}"
