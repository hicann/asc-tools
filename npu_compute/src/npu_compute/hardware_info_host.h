 ...
 */
#ifndef NPU_COMPUTE_SRC_NPU_COMPUTE_HARDWARE_INFO_HOST_H_
#define NPU_COMPUTE_SRC_NPU_COMPUTE_HARDWARE_INFO_HOST_H_
...
#endif // NPU_COMPUTE_SRC_NPU_COMPUTE_HARDWARE_INFO_HOST_H_
