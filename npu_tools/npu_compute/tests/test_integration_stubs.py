...
def test_prof_api_loads_only_the_formal_compute_entry():
    source = (ROOT / "injection/tests/stubs/prof_api/prof_api_stub.cpp").read_text(
        encoding="utf-8"
    )
...
def test_prof_api_constants_are_private_to_the_stub():
    ...
    prof_common = (
        ROOT / "injection/tests/stubs/prof_api/include/profiling/prof_common.h"
    ).read_text(encoding="utf-8")
    prof_stub = (ROOT / "injection/tests/stubs/prof_api/prof_api_stub.cpp").read_text(
        encoding="utf-8"
    )
