 ...
 */
#ifndef NPU_TOOLS_NPU_COMPUTE_SRC_COMPUTE_RUNTIME_SECTION_CONFIG_H
#define NPU_TOOLS_NPU_COMPUTE_SRC_COMPUTE_RUNTIME_SECTION_CONFIG_H
...
#endif // NPU_TOOLS_NPU_COMPUTE_SRC_COMPUTE_RUNTIME_SECTION_CONFIG_H
