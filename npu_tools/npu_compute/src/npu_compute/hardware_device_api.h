 ...
 */
#ifndef NPU_COMPUTE_SRC_NPU_COMPUTE_HARDWARE_DEVICE_API_H_
#define NPU_COMPUTE_SRC_NPU_COMPUTE_HARDWARE_DEVICE_API_H_
...
#endif // NPU_COMPUTE_SRC_NPU_COMPUTE_HARDWARE_DEVICE_API_H_
