 ...
 */
#ifndef NPU_COMPUTE_SRC_COMPUTE_LAUNCHER_REP_ENCODER_H_
#define NPU_COMPUTE_SRC_COMPUTE_LAUNCHER_REP_ENCODER_H_
...
#endif // NPU_COMPUTE_SRC_COMPUTE_LAUNCHER_REP_ENCODER_H_
