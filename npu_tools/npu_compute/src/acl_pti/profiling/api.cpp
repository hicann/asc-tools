...
{
    const aclptiResult result = aclpti::profiling::GetReplayRuntime().SetConfig(pParams);
    npucompute::detail::DebugLog("aclpti", "range config result=%d", static_cast<int>(result));
    return result;
}
