 ...
 */
#ifndef NPU_TOOLS_NPU_COMPUTE_INCLUDE_NPU_COMPUTE_COMMON_H
#define NPU_TOOLS_NPU_COMPUTE_INCLUDE_NPU_COMPUTE_COMMON_H
...
#endif // NPU_TOOLS_NPU_COMPUTE_INCLUDE_NPU_COMPUTE_COMMON_H
