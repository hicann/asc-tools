...
#ifndef NPU_TOOLS_NPU_CHECK_SRC_PROCESSOR_CHECKER_SYNCCHECK_H
#define NPU_TOOLS_NPU_CHECK_SRC_PROCESSOR_CHECKER_SYNCCHECK_H
...
#endif // NPU_TOOLS_NPU_CHECK_SRC_PROCESSOR_CHECKER_SYNCCHECK_H
