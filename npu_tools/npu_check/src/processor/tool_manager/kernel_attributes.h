...
#ifndef NPU_TOOLS_NPU_CHECK_SRC_PROCESSOR_TOOL_MANAGER_KERNEL_ATTRIBUTES_H
#define NPU_TOOLS_NPU_CHECK_SRC_PROCESSOR_TOOL_MANAGER_KERNEL_ATTRIBUTES_H
...
#endif // NPU_TOOLS_NPU_CHECK_SRC_PROCESSOR_TOOL_MANAGER_KERNEL_ATTRIBUTES_H
