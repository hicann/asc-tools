...
#ifndef NPU_TOOLS_NPU_CHECK_SRC_SHARED_WIRE_PROTOCOL_H
#define NPU_TOOLS_NPU_CHECK_SRC_SHARED_WIRE_PROTOCOL_H
...
#endif // NPU_TOOLS_NPU_CHECK_SRC_SHARED_WIRE_PROTOCOL_H
