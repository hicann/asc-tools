...
#ifndef NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_ACLSAN_DEVICE_DATA_H
#define NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_ACLSAN_DEVICE_DATA_H
...
#endif // NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_ACLSAN_DEVICE_DATA_H
