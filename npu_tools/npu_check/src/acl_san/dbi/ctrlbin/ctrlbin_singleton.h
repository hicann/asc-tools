...
#ifndef NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_DBI_CTRLBIN_CTRLBIN_SINGLETON_H
#define NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_DBI_CTRLBIN_CTRLBIN_SINGLETON_H
...
#endif // NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_DBI_CTRLBIN_CTRLBIN_SINGLETON_H
