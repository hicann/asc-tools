...
#ifndef NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_DBI_TRACE_BUFFER_ABI_H
#define NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_DBI_TRACE_BUFFER_ABI_H
...
#endif // NPU_TOOLS_NPU_CHECK_SRC_ACL_SAN_DBI_TRACE_BUFFER_ABI_H
