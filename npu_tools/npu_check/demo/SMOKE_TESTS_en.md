...
`npu_tools/npu_check/demo/examples`. The tests quickly verify example compilation,
...
```bash
bash npu_tools/npu_check/demo/run_smoke.sh
```
...
```bash
bash npu_tools/npu_check/demo/examples/memcheck/datacopy_stride/run.sh
```
...
```bash
bash npu_tools/npu_check/demo/examples/memcheck/memory_access/run.sh
```
...
```bash
bash npu_tools/npu_check/demo/examples/memcheck/memory_access/check_memory_access_end_to_end.sh all
```
...
```bash
bash npu_tools/npu_check/demo/examples/basic_func/multi_kernel/run.sh
...
```bash
bash npu_tools/npu_check/demo/examples/memcheck/matmul_leakyrelu_basic_api/run.sh
```
...
```bash
bash npu_tools/npu_check/demo/examples/synccheck/run_all.sh
```
