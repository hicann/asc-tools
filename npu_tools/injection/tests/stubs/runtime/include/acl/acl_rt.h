 ...
 */
#ifndef INJECTION_STUBS_RUNTIME_INCLUDE_ACL_ACL_RT_H_
#define INJECTION_STUBS_RUNTIME_INCLUDE_ACL_ACL_RT_H_
...
#endif // INJECTION_STUBS_RUNTIME_INCLUDE_ACL_ACL_RT_H_
