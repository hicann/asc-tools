...
foreach(removed_file IN ITEMS include/dbi/acl_hook.h src/dbi/acl_hook.cpp)
  if(EXISTS "${DBI_ROOT}/${removed_file}")
    message(FATAL_ERROR "DBI legacy ACL hook file must remain deleted: ${removed_file}")
  endif()
endforeach()

file(GLOB dbi_headers "${DBI_ROOT}/include/dbi/*.h")
file(GLOB dbi_sources "${DBI_ROOT}/src/dbi/*.cpp")
set(dbi_content "")
