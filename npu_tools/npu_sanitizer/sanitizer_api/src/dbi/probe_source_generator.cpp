...
const std::array<ProbeDefinition, 141> kDefinitions{{
    ...
    {463, ProbeGroup::Sync, "__sanitizer_report_rls_bufi_v",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t bufId, bool mode)PARAM", "Synchronization",
     "PIPE_S", R"ARGS(static_cast<uint64_t>(PIPE_V), bufId, static_cast<uint64_t>(mode), 0UL, 0UL)ARGS"},
    {151, ProbeGroup::Mte1, "__sanitizer_report_load_cbuf_to_ca_mx_2dv2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t dst, __cbuf__ void* src, uint64_t config0, uint64_t config1)PARAM",
     "MemoryAccess", "PIPE_MTE1", R"ARGS(dst, reinterpret_cast<uint64_t>(src), config0, config1, 0UL)ARGS"},
    {152, ProbeGroup::Mte1, "__sanitizer_report_load_cbuf_to_cb_mx_2dv2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t dst, __cbuf__ void* src, uint64_t config0, uint64_t config1)PARAM",
     "MemoryAccess", "PIPE_MTE1", R"ARGS(dst, reinterpret_cast<uint64_t>(src), config0, config1, 0UL)ARGS"},
    {400, ProbeGroup::Matrix, "__sanitizer_report_mad_s8",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {401, ProbeGroup::Matrix, "__sanitizer_report_mad_f16_f32",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {402, ProbeGroup::Matrix, "__sanitizer_report_mad_bf16_f32",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {403, ProbeGroup::Matrix, "__sanitizer_report_mad_f32_f32",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {404, ProbeGroup::Matrix, "__sanitizer_report_mad_e4m3_e4m3",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {405, ProbeGroup::Matrix, "__sanitizer_report_mad_e4m3_e5m2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {406, ProbeGroup::Matrix, "__sanitizer_report_mad_e5m2_e4m3",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {407, ProbeGroup::Matrix, "__sanitizer_report_mad_e5m2_e5m2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {408, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e1m2_e1m2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {409, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e1m2_e2m1",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {410, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e2m1_e1m2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {411, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e2m1_e2m1",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {412, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e4m3_e4m3",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {413, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e4m3_e5m2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {414, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e5m2_e4m3",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {415, ProbeGroup::Matrix, "__sanitizer_report_mad_mx_e5m2_e5m2",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __cc__ void* c, __ca__ void* a, __cb__ void* b, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_M",
     R"ARGS(reinterpret_cast<uint64_t>(c), reinterpret_cast<uint64_t>(a), reinterpret_cast<uint64_t>(b), config, 0UL)ARGS"},
    {174, ProbeGroup::Vector, "__sanitizer_report_copy_ubuf_to_ubuf",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __ubuf__ void* dst, __ubuf__ void* src, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_V",
     R"ARGS(reinterpret_cast<uint64_t>(dst), reinterpret_cast<uint64_t>(src), config, 0UL, 0UL)ARGS"},
    {175, ProbeGroup::Vector, "__sanitizer_report_scatter_vnchwconv_b16",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t dst, uint64_t src, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_V", R"ARGS(dst, src, config, 0UL, 0UL)ARGS"},
    {176, ProbeGroup::Vector, "__sanitizer_report_scatter_vnchwconv_b32",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t dst, uint64_t src, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_V", R"ARGS(dst, src, config, 0UL, 0UL)ARGS"},
    {177, ProbeGroup::Vector, "__sanitizer_report_scatter_vnchwconv_b8",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t dst, uint64_t src, uint64_t config, uint64_t dstHighHalf, uint64_t srcHighHalf)PARAM",
     "MemoryAccess", "PIPE_V", R"ARGS(dst, src, config, dstHighHalf, srcHighHalf)ARGS"},
    {178, ProbeGroup::Vector, "__sanitizer_report_vtranspose",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __ubuf__ void* dst, __ubuf__ void* src)PARAM",
     "MemoryAccess", "PIPE_V",
     R"ARGS(reinterpret_cast<uint64_t>(dst), reinterpret_cast<uint64_t>(src), 0UL, 0UL, 0UL)ARGS"},
    {417, ProbeGroup::Vector, "__sanitizer_report_ldva",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t dst, uint64_t src, uint64_t h)PARAM",
     "MemoryAccess", "PIPE_V", R"ARGS(dst, src, h, 0UL, 0UL)ARGS"},
    {418, ProbeGroup::Vector, "__sanitizer_report_vbs32_f16",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __ubuf__ void* dst, __ubuf__ void* src0, __ubuf__ void* src1, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_V",
     R"ARGS(reinterpret_cast<uint64_t>(dst), reinterpret_cast<uint64_t>(src0), reinterpret_cast<uint64_t>(src1), config, 0UL)ARGS"},
    {419, ProbeGroup::Vector, "__sanitizer_report_vbs32_f32",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __ubuf__ void* dst, __ubuf__ void* src0, __ubuf__ void* src1, uint64_t config)PARAM",
     "MemoryAccess", "PIPE_V",
     R"ARGS(reinterpret_cast<uint64_t>(dst), reinterpret_cast<uint64_t>(src0), reinterpret_cast<uint64_t>(src1), config, 0UL)ARGS"},
    {420, ProbeGroup::Vector, "__sanitizer_report_vmrgsort4_f16",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __ubuf__ void* dst, __ubuf__ void* src, uint64_t xm, uint64_t xt)PARAM",
     "MemoryAccess", "PIPE_V",
     R"ARGS(reinterpret_cast<uint64_t>(dst), reinterpret_cast<uint64_t>(src), xm, xt, 0UL)ARGS"},
    {421, ProbeGroup::Vector, "__sanitizer_report_vmrgsort4_f32",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __ubuf__ void* dst, __ubuf__ void* src, uint64_t xm, uint64_t xt)PARAM",
     "MemoryAccess", "PIPE_V",
     R"ARGS(reinterpret_cast<uint64_t>(dst), reinterpret_cast<uint64_t>(src), xm, xt, 0UL)ARGS"},
    {58, ProbeGroup::Scalar, "__sanitizer_report_st_atomic_b8",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t addr, int64_t offset, uint64_t post)PARAM",
     "MemoryAccess", "PIPE_S", R"ARGS(addr, static_cast<uint64_t>(offset), post, 0UL, 0UL)ARGS"},
    {62, ProbeGroup::Scalar, "__sanitizer_report_dc_preload",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __gm__ uint64_t* address, int64_t offset)PARAM",
     "MemoryAccess", "PIPE_S",
     R"ARGS(reinterpret_cast<uint64_t>(address), static_cast<uint64_t>(offset), 0UL, 0UL, 0UL)ARGS"},
    {63, ProbeGroup::Scalar, "__sanitizer_report_dc_preloadi",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, __gm__ uint64_t* address, int16_t offset)PARAM",
     "MemoryAccess", "PIPE_S",
     R"ARGS(reinterpret_cast<uint64_t>(address), static_cast<uint64_t>(static_cast<int64_t>(offset)), 0UL, 0UL, 0UL)ARGS"},
    {123, ProbeGroup::Scalar, "__sanitizer_report_set_channel_para",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t value)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(value, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {160, ProbeGroup::Scalar, "__sanitizer_report_set_ffts_base_addr",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t config)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(config, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {161, ProbeGroup::Scalar, "__sanitizer_report_set_fpc",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t config)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(config, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {162, ProbeGroup::Scalar, "__sanitizer_report_set_quant_pre",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t config)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(config, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {163, ProbeGroup::Scalar, "__sanitizer_report_set_quant_post",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t config)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(config, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {164, ProbeGroup::Scalar, "__sanitizer_report_set_lrelu_alpha",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t config)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(config, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {386, ProbeGroup::Scalar, "__sanitizer_report_set_fmatrix",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t value)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(value, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {387, ProbeGroup::Scalar, "__sanitizer_report_set_fmatrix_b",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t value)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(value, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {390, ProbeGroup::Scalar, "__sanitizer_report_set_l3d_rpt",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t value)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(value, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {391, ProbeGroup::Scalar, "__sanitizer_report_set_l3d_rpt_b",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t value)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(value, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {393, ProbeGroup::Scalar, "__sanitizer_report_set_padding_b",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, uint64_t value)PARAM", "RegisterState", "PIPE_S",
     R"ARGS(value, 0UL, 0UL, 0UL, 0UL)ARGS"},
    {439, ProbeGroup::Sync, "__sanitizer_report_pipe_barrier",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, pipe_t pipe)PARAM", "Synchronization", "PIPE_S",
     R"ARGS(static_cast<uint64_t>(pipe), 0UL, 0UL, 0UL, 0UL)ARGS"},
    {452, ProbeGroup::Sync, "__sanitizer_report_set_intra_block",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, pipe_t pipe, uint64_t syncId)PARAM", "Synchronization",
     "PIPE_S", R"ARGS(static_cast<uint64_t>(pipe), syncId, 0UL, 0UL, 0UL)ARGS"},
    {453, ProbeGroup::Sync, "__sanitizer_report_set_intra_blocki",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, pipe_t pipe, uint8_t syncId)PARAM", "Synchronization",
     "PIPE_S", R"ARGS(static_cast<uint64_t>(pipe), static_cast<uint64_t>(syncId), 0UL, 0UL, 0UL)ARGS"},
    {454, ProbeGroup::Sync, "__sanitizer_report_wait_intra_block",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, pipe_t pipe, uint64_t syncId)PARAM", "Synchronization",
     "PIPE_S", R"ARGS(static_cast<uint64_t>(pipe), syncId, 0UL, 0UL, 0UL)ARGS"},
    {455, ProbeGroup::Sync, "__sanitizer_report_wait_intra_blocki",
     R"PARAM(__gm__ uint8_t* memInfo, int64_t pc, uint32_t bid, pipe_t pipe, uint8_t syncId)PARAM", "Synchronization",
     "PIPE_S", R"ARGS(static_cast<uint64_t>(pipe), static_cast<uint64_t>(syncId), 0UL, 0UL, 0UL)ARGS"},
}};
...
bool IsKnownGroup(ProbeGroup group)
{
    return group == ProbeGroup::Mte1 || group == ProbeGroup::Mte2 || group == ProbeGroup::Mte3 ||
           ...
           group == ProbeGroup::Matrix || group == ProbeGroup::Vector;
}
