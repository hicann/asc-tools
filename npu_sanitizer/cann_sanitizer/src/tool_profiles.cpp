...
constexpr CallbackSelector kMemcheckCallbacks[] = {
    ...
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE2},
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE3},
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_FIXPIPE},
...
constexpr CallbackSelector kRacecheckCallbacks[] = {
    ...
    {ASCSAN_CB_DOMAIN_SYNCHRONIZE, ASCSAN_CBID_SYNCHRONIZE_STREAM_SYNC_END},
    {ASCSAN_CB_DOMAIN_SYNCHRONIZE, ASCSAN_CBID_SYNCHRONIZE_DEVICE_SYNC_END},
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_SET_WAIT_FLAG},
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_GET_RLS_BUF},
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE2},
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE3},
    {ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_FIXPIPE},
};
