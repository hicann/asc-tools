...
void DummyChecker::RegisterMemcheck()
{
    ...
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE2, &DummyChecker::OnInstruction);
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE3, &DummyChecker::OnInstruction);
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_FIXPIPE, &DummyChecker::OnInstruction);
}
...
void DummyChecker::RegisterRacecheck()
{
    ...
    Register(ASCSAN_CB_DOMAIN_SYNCHRONIZE, ASCSAN_CBID_SYNCHRONIZE_STREAM_SYNC_END, &DummyChecker::OnSynchronize);
    Register(ASCSAN_CB_DOMAIN_SYNCHRONIZE, ASCSAN_CBID_SYNCHRONIZE_DEVICE_SYNC_END, &DummyChecker::OnSynchronize);
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_SET_WAIT_FLAG, &DummyChecker::OnInstruction);
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_GET_RLS_BUF, &DummyChecker::OnInstruction);
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE2, &DummyChecker::OnInstruction);
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_MTE3, &DummyChecker::OnInstruction);
    Register(ASCSAN_CB_DOMAIN_DEVICE_INSTRUCTION, ASCSAN_CBID_DEVICE_INSTRUCTION_FIXPIPE, &DummyChecker::OnInstruction);
}
