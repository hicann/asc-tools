...
using NpusanSyncErrorDetail =
    std::variant<NpusanSyncBarrierError, NpusanSyncPairingError, NpusanSyncSequenceError,
                 NpusanSyncObjectError>;
...
struct NpusanReportRecord {
    ...
    using Payload = std::variant<std::monostate,
                                 const NpusanMemcheckReport*,
                                 const NpusanInitcheckReport*,
                                 const NpusanRacecheckReport*,
                                 const NpusanSynccheckReport*,
                                 const NpusanSoccheckReport*>;
