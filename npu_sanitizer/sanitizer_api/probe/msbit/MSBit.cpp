...
struct InjectInfo {
    ...
    {
        FuncInfo info{};
        info.instrId = instrId;
        info.injectFuncId = injectFuncId;
        info.paraNum = static_cast<uint16_t>(paraMask.size());
...
public:
    ...
    void Serialize(stringstream& ss)
    {
        ...
        funcNameList.size = static_cast<uint32_t>(funcLists.size() + sizeof(FuncNameList));
