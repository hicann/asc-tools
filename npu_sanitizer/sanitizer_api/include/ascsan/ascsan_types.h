...
typedef uint64_t AscsanSubscriberHandle;
...
typedef enum AscsanCallbackId {
    ASCSAN_CBID_RESOURCE_MEMORY_ALLOC = 100,
    ASCSAN_CBID_RESOURCE_MEMORY_FREE = 101,
    ASCSAN_CBID_RESOURCE_MODULE_LOAD = 102,
    ASCSAN_CBID_RESOURCE_MODULE_UNLOAD = 103,
    ASCSAN_CBID_RESOURCE_FUNCTION_GET = 104,

    ASCSAN_CBID_MEMORY_MEMCPY_BEGIN = 200,
    ASCSAN_CBID_MEMORY_MEMCPY_END = 201,
    ASCSAN_CBID_MEMORY_MEMSET_BEGIN = 202,
    ASCSAN_CBID_MEMORY_MEMSET_END = 203,

    ASCSAN_CBID_BINARY_LOAD_BEGIN = 300,
    ASCSAN_CBID_BINARY_LOAD_END = 301,

    ASCSAN_CBID_PATCH_BEGIN = 400,
    ASCSAN_CBID_PATCH_END = 401,
    ASCSAN_CBID_PATCH_SITE_MAP_CREATED = 402,

    ASCSAN_CBID_LAUNCH_BEGIN = 500,
    ASCSAN_CBID_LAUNCH_END = 501,

    ASCSAN_CBID_SYNCHRONIZE_STREAM_SYNC_END = 600,
    ASCSAN_CBID_SYNCHRONIZE_DEVICE_SYNC_END = 601,
    ASCSAN_CBID_SYNCHRONIZE_END = ASCSAN_CBID_SYNCHRONIZE_STREAM_SYNC_END,

    ASCSAN_CBID_DEVICE_INSTRUCTION_SET_WAIT_FLAG = 700,
    ASCSAN_CBID_DEVICE_INSTRUCTION_GET_RLS_BUF = 701,
    ASCSAN_CBID_DEVICE_INSTRUCTION_MTE2 = 702,
    ASCSAN_CBID_DEVICE_INSTRUCTION_MTE3 = 703,
    ASCSAN_CBID_DEVICE_INSTRUCTION_FIXPIPE = 704,

    ASCSAN_CBID_REPORT_RECORD = 800,
    ASCSAN_CBID_ERROR_RECORD = 900
} AscsanCallbackId;
