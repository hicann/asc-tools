...
extern "C" AscsanStatus ascsanFinalize(void)
{
    return ASCSAN_GUARDED_STATUS(ApiCore::Instance().Finalize());
}

extern "C" const char *ascsanGetVersionString(void)
{
    return ApiCore::Instance().VersionString();
}
...
extern "C" const AscsanLaunchConfig *ascsanGetLaunchConfig(void)
{
    return ApiCore::Instance().GetLaunchConfig();
}

extern "C" AscsanStatus ascsanSubscribe(const AscsanSubscribeDesc *desc,
                                         AscsanSubscriberHandle *subscriber)
{
...
extern "C" AscsanStatus ascsanEnableCallback(AscsanSubscriberHandle subscriber,
...
extern "C" AscsanStatus ascsanEnableDomain(AscsanSubscriberHandle subscriber,
                                            AscsanCallbackDomain domain,
                                            int enable)
{
...
extern "C" AscsanStatus ascsanGetCallbackState(AscsanSubscriberHandle subscriber,
                                                AscsanCallbackDomain domain,
                                                uint32_t cbid,
                                                int *enabled)
{
...
extern "C" int ascsanIsInsideCallback(void)
{
    return ApiCore::Instance().IsInsideCallback() ? 1 : 0;
}
...
extern "C" AscsanStatus ascsanRegisterPatchImage(const AscsanPatchImageDesc *desc,
                                                  uint64_t *patchImageId)
{
...
extern "C" AscsanStatus ascsanBuildPatchPlanForBinary(AscsanBinaryHandle binary,
                                                       AscsanPatchPlanHandle *plan)
{
    return ASCSAN_GUARDED_STATUS(ApiCore::Instance().BuildPatchPlanForBinary(binary, plan));
}

extern "C" AscsanStatus ascsanPatchBinaryFromImage(const AscsanPatchImageDesc *image,
                                                    const AscsanPatchOptions *options,
                                                    char *patchedPath,
                                                    uint64_t patchedPathSize,
                                                    AscsanPatchPlanHandle *plan)
{
    return ASCSAN_GUARDED_STATUS(ApiCore::Instance().PatchBinaryFromImage(
        image, options, patchedPath, patchedPathSize, plan));
}
...
{
    return ASCSAN_GUARDED_STATUS(ApiCore::Instance().SetLaunchUserData(
        launch, function, stream, deviceUserData, deviceUserDataSize));
}

extern "C" AscsanStatus ascsanMemoryAlloc(const AscsanMemoryAllocDesc *desc,
                                           void **ptr,
...
extern "C" AscsanStatus ascsanMemoryMemcpy(void *dst,
                                            uint64_t dstMax,
                                            const void *src,
                                            uint64_t bytes,
...
extern "C" AscsanStatus ascsanMemoryMemcpyAsync(void *dst,
                                                 uint64_t dstMax,
                                                 const void *src,
                                                 uint64_t bytes,
                                                 AscsanMemcpyKind kind,
...
extern "C" AscsanStatus ascsanMemoryMemset(void *dst,
                                            uint64_t dstMax,
                                            int32_t value,
                                            uint64_t bytes)
{
...
extern "C" AscsanStatus ascsanMemoryMemsetAsync(void *dst,
                                                 uint64_t dstMax,
                                                 int32_t value,
                                                 uint64_t bytes,
                                                 void *)
...
{
    return ASCSAN_GUARDED_STATUS(ApiCore::Instance().MemoryMemcpy(
        dstHost, bytes, srcDevice, bytes, ASCSAN_MEMCPY_DEVICE_TO_HOST));
}

extern "C" AscsanStatus ascsanMemcpyH2D(void *dstDevice, const void *srcHost, uint64_t bytes)
{
    return ASCSAN_GUARDED_STATUS(ApiCore::Instance().MemoryMemcpy(
        dstDevice, bytes, srcHost, bytes, ASCSAN_MEMCPY_HOST_TO_DEVICE));
}
...
extern "C" AscsanStatus ascsanFlushReports(void)
{
    return ASCSAN_GUARDED_STATUS(ApiCore::Instance().FlushReports());
}
